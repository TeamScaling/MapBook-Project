package com.scaling.libraryservice.search.engine.converter;
...
public class KeyboardUtil {
     ...
     * 초성 정보를 제공한다.
     * <p>
     * - 초성과 매칭된 코드 조회 - 한 자로 이루어진 초성코드만 존재한다.
     *
     * @param index
     * @param word
     * @return
    ...
    public static Map<String, Integer> getInfoForChoSung(int index, String word) {
        int code = KeyboardUtil.makeUnicodeIndex(CodeType.CHOSUNG,
     ...
     * 중성 정보를 제공한다.
     * <p>
     * - 중성과 매칭된 코드 조회 - 두 자로 이루어진 중성코드가 존재한다.
     *
     * @param index
     * @param word
     * @return
     ...
     * 종성 정보를 제공한다.
     * <p>
     * - 종성과 매칭된 코드 조회 - 두 자로 이루어진 종성코드가 존재한다.
     *
     * @param index
     * @param word
     * @return

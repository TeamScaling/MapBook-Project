...
class UserLibraryGeocoderTestInfo {
    ...
    void setUp() {
        ...
        //각 지역별 도서관
        LibraryInfo libraryInfo1 = LibraryInfo.builder().libNm("강서구 도서관").areaCd(areaCd2).libLat(37.5473333)
            .libLon(126.8731625)
            .build();

        LibraryInfo libraryInfo2 = LibraryInfo.builder().libNm("송파구 도서관").areaCd(areaCd1).libLat(37.5272233)
            .libLon(127.1177482).build();

        LibraryInfo libraryInfo3 = LibraryInfo.builder().libNm("동작구 도서관").areaCd(areaCd3).libLat(37.4978365)
            .libLon(126.9474396)
            .build();

        //도서관 정보를 담는 list
        libraries = List.of(libraryInfo1, libraryInfo2, libraryInfo3);
    }
